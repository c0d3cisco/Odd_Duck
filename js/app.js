...
// construct function
function Images(nameImg, source) {
...
Images.prototype.shownCounter = function () {
  this.shownTimes++;
};

//resets both properties and list of results
Images.prototype.resetAction = function () {
...
picsAvailable.push(new Images('bag', 'assets/bag.jpg'));
picsAvailable.push(new Images('banana', 'assets/banana.jpg'));
picsAvailable.push(new Images('bathroom', 'assets/bathroom.jpg'));
picsAvailable.push(new Images('boots', 'assets/boots.jpg'));
picsAvailable.push(new Images('breakfast', 'assets/breakfast.jpg'));
picsAvailable.push(new Images('bubblegum', 'assets/bubblegum.jpg'));
picsAvailable.push(new Images('chair', 'assets/chair.jpg'));
picsAvailable.push(new Images('cthulhu', 'assets/cthulhu.jpg'));
picsAvailable.push(new Images('dog-duck', 'assets/dog-duck.jpg'));
picsAvailable.push(new Images('dragon', 'assets/dragon.jpg'));
picsAvailable.push(new Images('pen', 'assets/pen.jpg'));
picsAvailable.push(new Images('pet-sweep', 'assets/pet-sweep.jpg'));
picsAvailable.push(new Images('scissors', 'assets/scissors.jpg'));
picsAvailable.push(new Images('shark', 'assets/shark.jpg'));
picsAvailable.push(new Images('sweep', 'assets/sweep.png'));
picsAvailable.push(new Images('tauntaun', 'assets/tauntaun.jpg'));
picsAvailable.push(new Images('unicorn', 'assets/unicorn.jpg'));
picsAvailable.push(new Images('water-can', 'assets/water-can.jpg'));
picsAvailable.push(new Images('wine-glass', 'assets/wine-glass.jpg'));
